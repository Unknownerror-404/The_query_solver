...
class MapHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if path == "/industry-admin":
            ...
            self.send_html(template.replace("__CONTENT__", render_industry_admin()))
            return
        ...
        payload = template.replace("__ISSUES__", issues_json).replace("__USER__", html.escape(user)).encode("utf-8")
