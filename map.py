...
class MapHandler(BaseHTTPRequestHandler):
    ...
    def do_GET(self) -> None:
        ...
        if path.startswith("/proof/"):
            ...
            proof = PROOF_IMAGES.get(proof_id)
            if proof is None:
                self.send_error(404)
                return
    ...
    def do_POST(self) -> None:
        ...
        if path == "/api/proposals":
            ...
            if issue is None:
                ...
                return
            proposal = {"id":NEXT_PROPOSAL_ID,"issue_id":issue_id,"title":title[:120],"description":description[:3000],"author":user,"votes":0,"status":"Submitted","visual":visual,"visual_type":visual_type,"review":None}
